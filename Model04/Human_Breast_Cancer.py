...
os.environ['R_HOME'] = 'D:/Program Files/R/R-4.3.1'

# sample name
data_path = "data/Human_Breast_Cancer"  #### to your path
data_name = 'S1'  #### project name
save_path = "Results/HBC"  #### save path
seed = 101
n_domains = 20
fix_seed(seed)
train = True
if train:
    ...
    adata.obs['layer_guess'] = list(df_meta['fine_annot_type'])
    ...
    deepen.HBC_get_cluster_data(adata, data_name, n_domains)
